...
<div class="container col-sm-10" style="text-align: center; border: 1px solid black; border-radius: 20px; margin-top: 20px; margin-bottom: 20px;">
	<h3>Calculate Cost</h3><hr>

	<form method="post" action="calculate_cost_backend.php" onsubmit="return itemsSelected()" enctype="multipart/form-data">
				...
				<center>
					<div class="col-sm-6">
						...
						<div class="row">
							...
							<input class="form-control" type="text" name="distance" id="distance" placeholder="Distance in kms" required/>
						</div>
						<br>
					</div>
				</center>
			...
			<div class="row">
				<div class="col-sm-6 input-group">
					<?php
						...
						{
							$cost = $_SESSION['calculated_cost'];
							echo 	'<div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon1">Rs.</span>
									</div>
									<input class="form-control" type="text" id="estimated-cost" name="cost" value="'.$cost.'" readonly><br>';
						}
					?>
				</div>
				<div class="col-sm-4">
					<button class="btn btn-primary" name="calculated_cost_button" >Calculate Cost</button>
				</div>
			</div>
		...
		<div class="row">
			<div class="col">
				<p>To book a slot click on the below link and make a token payment of 30% of the above calculated cost</p>
				<?php
					if(isset($_SESSION['calculated_cost']) && $_SESSION['calculated_cost'] != "0")
					{
						echo '<button class="btn btn-success" onclick="location.href = \'payment.php\';">Book a slot for moving?</button>';
					}
					else
					{
						echo '<button class="btn btn-success" onclick="location.href = \'payment.php\';" disabled>Book a slot for moving?</button>';
					}
				?>
